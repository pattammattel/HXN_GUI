...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi("/GPFS/XF03ID1/home/xf03id/user_macros/HXN_GUI/Analysis/xrf_xanes_gui.ui", self)
    ...
    def create_pyxrf_batch_macro(self):
        ...
        if self.rb_make_hdf.isChecked():
            ...
            return (make_hdf(first_sid,last_sid, wd = cwd, file_overwrite_existing=True), 
                    pyxrf_batch(first_sid, last_sid, wd = cwd, param_file_name =param, scaler_name=norm, save_tiff = True))

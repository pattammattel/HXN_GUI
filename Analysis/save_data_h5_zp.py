...
def load_data(scan_num,det_name,n,nn,mesh_flag,fly_flag,check_flag):
    ...
    for i in range(num_frame):
        ...
        #t = rm_pixel(t,87,120)
        #t = rm_pixel(t,115,105)
        #t = rm_pixel(t,392,291)
...
def save_data(scan_num,mesh_flag,fly_flag,n,nn,distance,check_flag=0):
    ...
    os.system('ln -s /data/home/xjhuang/GPU_ptycho/h5_data/scan_'+np.str(scan_num)+'.h5 /data/home/xjhuang/GPU_ptycho/scan_'+np.str(scan_num)+'.h5')

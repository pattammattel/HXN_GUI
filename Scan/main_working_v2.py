...
class Ui(QtWidgets.QMainWindow):
    ...
    def start_flyscan(self):
        ...
        det_list = {'dets1':dets1,'dets2':dets2,'dets3':dets3,
                    ...
                    'dets7':dets7,'dets8':dets8,'dets9':dets9,
                    'dets10':dets10,'dets11':dets11,'dets_fs':dets_fs
    ...
    def fill_common_scan_params(self):
        common_scans = {scan1: {x_start: -15, x_end: 15, y_start: -15, y_end: 15, x_step: 30, y_step: 30, dwell: 0.03},

                        scan2: {x_start: -1, x_end: 1, y_start: -1, y_end: 1, x_step: 100, y_step: 100, dwell: 0.03},

                        scan3: x_start:-3, x_end: 3, y_start: -3, y_end: 3, x_step: 100, y_step: 100, dwell: 0.05},

        scan4: {x_start: -10, x_end: 10, y_start: -10, y_end: 10, x_step: 100, y_step: 100, dwell: 0.03}}

...
def export_diff_data_as_h5_batch(
    ...
    """
    Batch export of multiple scans. Dispatches to the correct export function.
    Always sets save_and_return=False to ensure logs are lightweight.
    """
    logs = []
    for sid in scan_ids:
        try:
            result = export_diff_data_as_h5_single(
                sid,
                det=det,
                wd=wd,
                mon=mon,
